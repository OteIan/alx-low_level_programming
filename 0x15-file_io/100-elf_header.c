...
/**
 * main - Displays info. contained in the ELF file
 *
 * @argc: argument count
 ...
 *
 * @e_ident: array containing ELF magic numbers
 *
...
/**
 * print_entry - Prints the entry of a ELF header
 *
